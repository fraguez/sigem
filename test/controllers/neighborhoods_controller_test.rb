...
class NeighborhoodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create neighborhood" do
    assert_difference('Neighborhood.count') do
      post neighborhoods_url, params: { neighborhood: { code: @neighborhood.code, district_id: @neighborhood.district_id, name: @neighborhood.name } }
    end
  ...
  test "should update neighborhood" do
    patch neighborhood_url(@neighborhood), params: { neighborhood: { code: @neighborhood.code, district_id: @neighborhood.district_id, name: @neighborhood.name } }
