...
class DocumentReferencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create document_reference" do
    assert_difference('DocumentReference.count') do
      post document_references_url, params: { document_reference: { code: @document_reference.code, name: @document_reference.name } }
    end
  ...
  test "should update document_reference" do
    patch document_reference_url(@document_reference), params: { document_reference: { code: @document_reference.code, name: @document_reference.name } }
