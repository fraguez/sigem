...
class VacationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vacation" do
    assert_difference('Vacation.count') do
      post vacations_url, params: { vacation: { detail: @vacation.detail, employee_id: @vacation.employee_id, enddate: @vacation.enddate, startdate: @vacation.startdate, state: @vacation.state } }
    end
  ...
  test "should update vacation" do
    patch vacation_url(@vacation), params: { vacation: { detail: @vacation.detail, employee_id: @vacation.employee_id, enddate: @vacation.enddate, startdate: @vacation.startdate, state: @vacation.state } }
