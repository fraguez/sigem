class CheckInsController < ApplicationController
  ...
  def index
    ...
    @check_ins, @number_of_pages = search.check_ins_by_name
  end
  ...
  def create
    ...
    respond_to do |format|
      if @check_in.save
        format.html { redirect_to check_ins_url, notice: 'Registro de Entrada Agregado.' }
  ...
  def update
    respond_to do |format|
      if @check_in.update(check_in_params)
        format.html { redirect_to check_ins_url, notice: 'Check in was successfully updated.' }
  ...
  def destroy
    @check_in.destroy
    respond_to do |format|
      format.html { redirect_to check_ins_url, notice: 'Registro de Entrada Eliminado.' }
  ...
  private
    ...
    def check_in_params
      params.require(:check_in).permit(:employee_id)
    end
end
