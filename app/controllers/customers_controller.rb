class CustomersController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @customer.update(customer_params)
        format.html { redirect_to customers_url, notice: 'Cliente actualizado.' }
  ...
  private
    ...
    def customer_params
      params.require(:customer).permit(:legalcertificate, :name, :businessname, :customer_type_id, :city_id, :state_id, :district_id, :neighborhood_id, :othersing)
    end
end
