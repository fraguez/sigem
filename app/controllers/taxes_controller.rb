class TaxesController < ApplicationController
  ...
  def index
    ...
    @taxes, @number_of_pages = search.taxes_by_name
  end
  ...
  def update
    respond_to do |format|
      if @tax.update(tax_params)
        format.html { redirect_to taxes_url, notice: 'Impuesto actualizado.' }
  ...
  def destroy
    @tax.destroy
    respond_to do |format|
      format.html { redirect_to taxes_url, notice: 'Impuesto eliminado.' }
  ...
  private
    ...
    def tax_params
      params.require(:tax).permit(:name, :code)
    end
end
