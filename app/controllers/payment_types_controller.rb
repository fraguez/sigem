class PaymentTypesController < ApplicationController
  ...
  def index
    ...
    @payment_types, @number_of_pages = search.payment_types_by_name
  end
  ...
  def create
    ...
    respond_to do |format|
      if @payment_type.save
        format.html { redirect_to payment_types_url, notice: 'Medio de Pago creado.' }
  ...
  def update
    respond_to do |format|
      if @payment_type.update(payment_type_params)
        format.html { redirect_to payment_types_url, notice: 'Medio de Pago actualizado.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to payment_types_url, notice: 'Medio de Pago eliminado.' }
  ...
  private
    ...
    def payment_type_params
      params.require(:payment_type).permit(:name, :code)
    end
end
